...
+ And repeat for the 7320 line, instead of 7330
#+BEGIN_SRC python :eval no :tangle oplus-alt-ratio-contour.py
  from __future__ import print_function
  import sys
  import numpy as np
  import pyneb as pn
...
#+BEGIN_SRC sh :results file
source activate pyneb27
python oplus-alt-ratio-contour.py
#+END_SRC

#+RESULTS:
[[file:oplus-alt-ratio-contour.pdf]]
